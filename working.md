...
OpenChain의 멤버로서, OPPO는 OpenChain이 ISO/IEC JTC1 국제표준으로 채택된 것을 매우 기쁘게 생각합니다. 우리는 이것이 오픈소스 컴플라이언스를 더욱 촉진하는데 도움이 될 것으로 믿습니다. OPPO는 오픈소스 컴플라이언스가 보다 일관되고 간편해질 수 있도록 파트너와 함께 OpenChain을 발전시켜 나가기를 희망합니다." 라고 OPPO의 부사장이자 소프트웨어 엔지니어링 부문장인 Andy Wu가 말했습니다.
